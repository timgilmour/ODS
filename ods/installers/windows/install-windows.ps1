...
if ($dryRun) {
    ...
    try {
        ...
        if ($gpuInfo.Backend -eq "amd" -and -not $cloudMode) {
            ...
            $preOdsLemonadeTaskName = "DreamServerLemonadeRuntime"
            ...
            if ($useLemonade) {
                ...
                Stop-ODSWindowsLemonadeProcesses -ExePath $script:LEMONADE_EXE -TaskNames @($taskName, $preOdsLemonadeTaskName)
