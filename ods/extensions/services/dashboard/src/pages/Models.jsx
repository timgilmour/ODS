      ...
      <div className="grid gap-4 xl:grid-cols-[260px_minmax(0,1fr)]">
        ...
        >
          <div className="min-w-full overflow-x-auto">
            <div className="lg:min-w-[1130px]">
              <div className="hidden grid-cols-[minmax(250px,1.7fr)_184px_36px_70px_110px_120px_90px_130px] gap-5 border-b border-theme-border px-5 py-3 text-[9px] font-semibold uppercase tracking-[0.18em] text-theme-text-muted/75 lg:grid">
                <span>Model</span>
                <span>Actions</span>
                <span />
                <span>Size</span>
...
function ModelTableRow({
  ...
  return (
    <div className="grid grid-cols-2 gap-x-3 gap-y-4 px-3 py-4 transition-colors hover:bg-theme-surface-hover/70 sm:grid-cols-[minmax(0,1fr)_auto] lg:grid-cols-[minmax(250px,1.7fr)_184px_36px_70px_110px_120px_90px_130px] lg:gap-5 lg:px-5 lg:py-3.5">
